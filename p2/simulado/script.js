...
let tecla_Pressionar=document.getElementById('resultadoKeydown')
let tecla_Pressionando=document.getElementById('resultadoKeypress')
let tecla_Soltar=document.getElementById('resultadoKeyup')

function aoPressionar(){
  if(tecla_Pressionar){
    tecla_Pressionar.innerHTML='Tecla pressionada'
  }
}

function aoPressionando(){
  if(tecla_Pressionando){
    tecla_Pressionando.innerHTML='Tecla pressionando'
  }
}

function aoSoltar(){
  if(tecla_Soltar){
    tecla_Soltar.innerHTML='Tecla solta'
  }
}
